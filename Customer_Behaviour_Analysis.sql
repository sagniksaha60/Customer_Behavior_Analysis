...
SELECT s.customer_id, SUM(
    CASE 
        WHEN s.order_date BETWEEN mb.join_date AND (mb.join_date + 7) THEN m.price*20
...
-- 13. Danny also requires further information about the ranking of products. He purposely does not need the 
-- ranking of non member purchases so he expects NULL ranking values for customers who are not yet part of 
-- the loyalty program.
